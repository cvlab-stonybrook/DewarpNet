...
def train(args):
    ...
    for epoch in range(epoch_start,args.n_epoch):
        ...
        if val_mse < best_val_mse:
            ...
            torch.save(state, "./checkpoints/{}_{}_{}_{}_{}_sp_varcam_scratch_l1norm_best_model.pkl".format(args.arch, args.dataset, epoch+1,val_mse,train_mse))
        ...
        if (epoch+1) % 10 == 0:
            ...
            state = {'epoch': epoch+1,
                     'model_state': model.state_dict(),
                     'optimizer_state' : optimizer.state_dict(),}
            torch.save(state, "./checkpoints/{}_{}_{}_{}_{}_sp_varcam_scrtach_l1norm_model.pkl".format(args.arch, args.dataset, epoch+1,val_mse,train_mse))
