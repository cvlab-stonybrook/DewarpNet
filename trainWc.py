...
def vistensor(tensor, epoch, ch=0, allkernels=False, nrow=8, padding=1): 
    ...
    plt.savefig('./generated/filters_layer1_wc_'+str(epoch)+'.png')
    plt.close()
...
def train(args):
    ...
    v_loader = data_loader(data_path, is_transform=True, split='valWcVc', img_size=(args.img_rows, args.img_cols), img_norm=args.img_norm)
    ...
    for epoch in range(epoch_start,args.n_epoch):
        ...
        for i_val, (images_val, labels_val) in tqdm(enumerate(valloader)):
            with torch.no_grad():
                ...
                pred=softp(target_nhwc).data.cpu()
        ...
        if val_mse < best_val_mse:
            ...
            torch.save(state, "./checkpoints/{}_{}_{}_{}_{}_sp_varcamWc_retrainfix_l1_best_model.pkl".format(args.arch, args.dataset, epoch+1,val_mse,train_mse))
        ...
        if (epoch+1) % 10 == 0:
            ...
            state = {'epoch': epoch+1,
                     'model_state': model.state_dict(),
                     'optimizer_state' : optimizer.state_dict(),}
            torch.save(state, "./checkpoints/{}_{}_{}_{}_{}_sp_varcamWc_retrainfix_l1_model.pkl".format(args.arch, args.dataset, epoch+1,val_mse,train_mse))
