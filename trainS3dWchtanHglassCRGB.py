...
def train(args):
    ...
    #Log file:
    experiment_name='hgc_htan_swat3dWcRGBvarYvarXvarXY_l1_bghsaug_retrainFixedvYvXl1grad' #net_activation_dataset_lossparams_augmentations_trainstart
    log_file=open('./checkpoints-swat3d/'+experiment_name+'.txt','w+')
    log_file.write('\n---------------  '+experiment_name+'  ---------------\n')
    log_file.close()

    best_val_mse = 0.000996064908612
    log_count=0
