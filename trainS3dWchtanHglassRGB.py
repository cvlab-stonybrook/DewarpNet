...
# uses hourglass of 2 unets with residual connection 
...
def write_log_file(experiment_name,losses, epoch, phase):
    with open('./checkpoints-swat3d/'+experiment_name+'.txt','a') as f:
        f.write("\n{} Epoch: {} Loss: {} MSE: {} FG: {} BG: {} GradLoss: {}".format(phase, epoch, losses[0], losses[1], losses[2], losses[3], losses[4]))
...
def train(args):
    ...
    if hasattr(model.module, 'optimizer'):
        ...
        optimizer= torch.optim.Adam(trainable_params,lr=args.l_rate, weight_decay=5e-4, amsgrad=True)
    ...
    #Log file:
    experiment_name='hg_htan_swat3dWcRGBvarYvarXvarXYRanK_l1grad0.5_bghsaug_retrainFixedvYvXRanKl1grad0.2' #net_activation_dataset_lossparams_augmentations_trainstart
    ...
    log_file.write('\n---------------  '+experiment_name+'  ---------------\n')
    log_file.write('\n module1 model: '+args.module1_model+'\n')
    log_file.close()

    best_val_mse = 0.00081313
    log_count=0
...
if __name__ == '__main__':
    ...
    # CUDA_VISIBLE_DEVICES=1 python trainS3dWchtanHglassRGB.py --arch hourglass --dataset swat3d --img_rows 256 --img_cols 256 --n_epoch 400 --batch_size 39 --l_rate 0.0001 --img_norm --module1_model ./checkpoints-swat3d/unetnc_swat3d_319_0.00101629343065_0.000858071765896_htan_swat3dWcRGBvarYvarX_l1grad0.7_bghsaug_retrainFixedvYvXl1_best_model.pkl --visdom
