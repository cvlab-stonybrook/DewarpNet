...
class dewarpnetmsLoader(data.Dataset):
    """
    ...
    def transform(self, img, lbl):
        ...
        msk = cv2.resize(msk, (self.img_size[0], self.img_size[1]), cv2.INTER_NEAREST)
        #lbl = lbl.astype(int)
        # print (lbl.shape)
...
#     dst = dewarpnetwcLoader(root=local_path, split='trainBmMeshsplitnew', is_transform=True, augmentations=True)
