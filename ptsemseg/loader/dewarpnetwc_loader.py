...
class dewarpnetwcLoader(data.Dataset):
    """
    Data loader for the  semantic segmentation dataset.
    """
    def __init__(self, root, split='trainnewmesh', is_transform=False,
        ...
        for split in ['trainnewmesh', 'valnewmesh']:
