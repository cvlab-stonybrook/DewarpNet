# Loader for backward mapping regression
# Adds two coord channels with input
...
class dewarpnetbmnoimgccLoader(data.Dataset):
    """
    ...
    def transform(self, wc, bm, alb):
        ...
        # print wc.shape
        # print 'here'
        img=np.concatenate([alb,wc,xx_coord,yy_coord],axis=0)
