...
class foldeddocwcLoader(data.Dataset):
    ...
    """
    def __init__(self, root, split='trainWcVc', is_transform=False,
        ...
        for split in ['trainWcVc', 'valWcVc']:
    ...
    def __getitem__(self, index):
        ...
        im_path = pjoin(self.root, 'ImagesDWBVarCam',  im_name + '.png')
        lbl_name = im_name.split('_')
        lbl_name = lbl_name[0]+'WC_'+lbl_name[1]+'.png'

        lbl_path = pjoin(self.root, 'worldCoordBVarCam',lbl_name) #DepthMapEXR_10001.exr
