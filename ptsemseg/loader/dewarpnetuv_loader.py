...
class dewarpnetuvLoader(data.Dataset):
    """
    ...
    def __getitem__(self, index):
        ...
        lbl_name = 'DCX'+lbl_id+lbl_name[3]+'.exr'         #WCX20001.exr
        lbl_path = pjoin(self.root, 'uv',foldr,lbl_name) 
    ...
    def transform(self, img, lbl):
        ...
        lbl = cv2.resize(lbl, (self.img_size[0], self.img_size[1]), cv2.INTER_LANCZOS4)
        #lbl = lbl.astype(int)
...
#     dst = dewarpnetuvLoader(root=local_path, split='trainWcdewarp', is_transform=True)
