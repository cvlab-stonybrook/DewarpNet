...
class dewarpnetbmLoader(data.Dataset):
    """
    ...
    def __getitem__(self, index):
        ...
        lbl_path = pjoin(self.root, 'bm-corrmesh',foldr,lbl_name) 
    ...
    def transform(self, img, wc, bm):
        ...
        xmx, xmn, ymx, ymn = 160.398227753507, -4.444446653356195, 192.11541842533654, -2.922456743468434
