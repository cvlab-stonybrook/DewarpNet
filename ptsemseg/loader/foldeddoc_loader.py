...
class foldeddocLoader(data.Dataset):
    """
    ...
    def __getitem__(self, index):
        ...
        lbl_path = pjoin(self.root, 'depthMapExrs','DepthMapEXR'+im_name[5:] + '.exr') #DepthMapEXR_10001.exr
        # print(im_path)
        im = m.imread(im_path)
...
#     dst = foldeddocLoader(root=local_path, split='val', is_transform=True)
