...
def train(args):
    ...
    # Setup Dataloader
    data_loader = get_loader(args.dataset+'uv')
    ...
    trainloader = data.DataLoader(t_loader, batch_size=args.batch_size, num_workers=32, shuffle=True)
    valloader = data.DataLoader(v_loader, batch_size=args.batch_size, num_workers=32)
    ...
    for epoch in range(epoch_start,args.n_epoch):
        ...
        for i, (images, labels) in enumerate(trainloader):
            ...
            # print(torch.max(pred_nhwc))
            # print(torch.min(pred_nhwc))
        ...
        if val_mse < best_val_mse:
            ...
            torch.save(state, "./checkpoints-uv/{}_{}_{}_{}_{}_ht_dewarpUv_scratch_l1_best_model.pkl".format(args.arch, args.dataset, epoch+1,val_mse,train_mse))
        ...
        if (epoch+1) % 10 == 0:
            ...
            state = {'epoch': epoch+1,
                     'model_state': model.state_dict(),
                     'optimizer_state' : optimizer.state_dict(),}
            torch.save(state, "./checkpoints-uv/{}_{}_{}_{}_{}_ht_dewarpUv_scratch_l1_model.pkl".format(args.arch, args.dataset, epoch+1,val_mse,train_mse))
