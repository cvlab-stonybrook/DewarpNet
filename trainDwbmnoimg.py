# code to train backward mapping regression from world coordinates (No CoordConv)
...
# ssim (bm), mse,ssim is best: dnet_dewarpnet_49_0.000709214014933_0.000172995541447_dewarpbmmeshplit_rescaled_retrain_ssimreconssim_best_model.pkl
# Comments: used dropouts to prevent overfitting, recon losses also prevent overfitting, 
...
def train(args):
    ...
    if hasattr(model.module, 'optimizer'):
        ...
        optimizer= torch.optim.Adam(model.parameters(),lr=args.l_rate, weight_decay=5e-3, amsgrad=True)
    ...
    for epoch in range(epoch_start,args.n_epoch):
        ...
        if val_mse < best_val_mse:
            ...
            torch.save(state, "./checkpoints-bm/{}_{}_{}_{}_{}_dewarpbmmeshplit_retrain_l1reconssiml1_best_model.pkl".format(args.arch, args.dataset, epoch+1,val_mse,train_mse))
        ...
        if (epoch+1) % 10 == 0:
            ...
            state = {'epoch': epoch+1,
                     'model_state': model.state_dict(),
                     'optimizer_state' : optimizer.state_dict(),}
            torch.save(state, "./checkpoints-bm/{}_{}_{}_{}_{}_dewarpbmmeshsplit_retrain_l1reconssiml1_model.pkl".format(args.arch, args.dataset, epoch+1,val_mse,train_mse))
