...
def test(args):
    ...
    lbl_path = os.path.join('/media/hilab/HiLabData/Sagnik/FoldedDocumentDataset/data/DepthTrain/', 'depthMapExrsSphCamTrain','DepthMapEXR'+im_name[5:-4] + '.exr') #DepthMapEXR_10001.exr
    print(lbl_path)
