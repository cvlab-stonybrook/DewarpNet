...
class swat3dwcLoader(data.Dataset):
    """
    ...
    def __getitem__(self, index):
        ...
        if self.augmentations:          #this is for training, default false for validation
            ...
            bg=cv2.resize(tex,(self.img_size[0], self.img_size[1]),interpolation=cv2.INTER_LANCZOS4)
    ...
    def transform(self, img, lbl):
        ...
        # xmx, xmn, ymx, ymn,zmx, zmn= 1.2485291, -1.2419288, 1.2317121, -1.2275329, 0.63452387, -0.67187124
