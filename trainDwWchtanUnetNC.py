...
# Activation is hardtanh, uses pix2pix unet as arch [this unet doesn't fail on real images]
# Loss is L1
# L1 best model: unetnc_dewarpnet_40_0.00510332081467_0.00691128028995_htan_dewarpWc_scratch30-60kallaug_l1_model.pkl
# using jointloss: unetnc_dewarpnet_290_0.00384727632627_0.00363837530326_htanjloss_dewarpWc_scratch30-60knoaug_l1_best_model.pkl
...
def train(args):
    ...
    v_loader = data_loader(data_path, is_transform=True, split='valnewmesh', img_size=(args.img_rows, args.img_cols), img_norm=args.img_norm)
    ...
    for epoch in range(epoch_start,args.n_epoch):
        ...
        for i, (images, labels) in enumerate(trainloader):
            ...
            if (i+1) % 50 == 0:
                ...
                if args.visdom:
                    ...
                    vis.images(out_arr,
                               win=train_out_win,
                               opts=dict(title='Train Outputs', caption='Wc_htan_allaug'))
                    vis.images(label_arr,
                               win=train_labels_win,
                               opts=dict(title='Train Labels', caption='Wc_htan_allaug'))
                    vis.images(inp_arr,
                               win=train_inputs_win,
                               opts=dict(title='Train Inputs', caption='Wc_htan_allaug'))
        ...
        for i_val, (images_val, labels_val) in tqdm(enumerate(valloader)):
            ...
            if args.visdom:
                ...
                vis.images(out_arr,
                           win=val_out_win,
                           opts=dict(title='Val Outputs', caption='Wc_htan_allaug'))
                vis.images(label_arr,
                           win=val_labels_win,
                           opts=dict(title='Val Labels', caption='Wc_htan_allaug'))
                vis.images(inp_arr,
                           win=val_inputs_win,
                           opts=dict(title='Val Inputs', caption='Wc_htan_allaug'))
        ...
        if val_mse < best_val_mse:
            ...
            torch.save(state, "./checkpoints/{}_{}_{}_{}_{}_htan_dewarpWc_scratch30-60kallaug_l1_best_model.pkl".format(args.arch, args.dataset, epoch+1,val_mse,train_mse))
        ...
        if (epoch+1) % 10 == 0:
            ...
            state = {'epoch': epoch+1,
                     'model_state': model.state_dict(),
                     'optimizer_state' : optimizer.state_dict(),}
            torch.save(state, "./checkpoints/{}_{}_{}_{}_{}_htan_dewarpWc_scratch30-60kallaug_l1_model.pkl".format(args.arch, args.dataset, epoch+1,val_mse,train_mse))
